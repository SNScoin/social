        ...
        {user && (
          <div className={`user-info-container${isCollapsed ? ' collapsed' : ''}`}> 
            ...
            <div className="user-settings-container">
              <button 
                ref={settingsBtnRef}
                className={`user-settings-btn ${isActive('/user-settings') ? 'active' : ''} ${isCollapsed ? 'collapsed' : ''}`}
                ...
                <div ref={dropdownRef} className="user-settings-dropdown open-up">
                  ...
                  >
                    ...
                    <div className="dropdown-content">
                      <div className="dropdown-title">Profile Settings</div>
                      <div className="dropdown-description">Manage your account</div>
                    </div>
                  </Link>
                  ...
                  >
                    ...
                    <div className="dropdown-content">
                      ...
                      <div className="dropdown-description">Logout from your account</div>
                    </div>
                  </button>
                </div>
              )}
